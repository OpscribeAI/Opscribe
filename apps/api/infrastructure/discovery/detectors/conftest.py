"""
Pytest configuration and fixtures for AWS detection tests.

This file provides shared fixtures for all tests in the infrastructure/discovery module.
"""
...
def mock_cluster_with_detailed_setup(mock_cluster):
    ...
    return {
        ...
        "expected_resource_count": 6,  # 2 EC2 + 1 RDS + 1 S3 + 1 SQS + 1 VPC
