import { Layout, Network, Database, Github, Plus, Settings, LogOut, CheckCircle, AlertCircle, ChevronRight } from "lucide-react";
...
export default function Sidebar({
  ...
  return (
    <aside className="w-72 h-screen bg-[#01040a] border-r border-white/5 flex flex-col z-20 shrink-0 sticky top-0">
      {/* Branding */}
      ...
      <div className="p-4 border-t border-white/5 space-y-3">
        <button 
            ...
            className="w-full flex items-center gap-3 px-3 py-2 text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors group"
        >
        ...
        <div className="flex items-center justify-between bg-white/[0.02] border border-white/5 rounded-xl p-3">
            ...
            <button
                onClick={onLogout}
                className="p-2 hover:bg-red-500/10 text-gray-500 hover:text-red-400 rounded-lg transition-colors group"
                title="Log Out"
            >
